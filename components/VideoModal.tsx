...
const TOUR_STEPS: TourStep[] = [
    {
        ...
        visual: (
            <div className="bg-surface rounded-xl p-6 border border-white/10 w-full max-w-md mx-auto">
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-3 h-3 rounded-full bg-rose-500" />
                    <div className="w-3 h-3 rounded-full bg-amber-500" />
                    <div className="w-3 h-3 rounded-full bg-emerald-500" />
                </div>
                <div className="bg-surfaceHighlight rounded-lg p-4 flex items-center gap-3 border border-white/5">
                ...
                <div className="space-y-2">
                    {[
                        ...
                        <div key={p.name} className="flex items-center gap-3">
                            <span className="text-xs text-text-muted w-16">{p.name}</span>
        ...
        visual: (
            <div className="w-full max-w-md mx-auto space-y-3">
                <div className="bg-surface rounded-lg p-4 border border-white/10">
                    ...
                    <p className="text-xs text-text-muted leading-relaxed line-through decoration-rose-500/30">
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.8 }}
                    className="bg-surface rounded-lg p-4 border border-emerald-500/30"
                >
        ...
        visual: (
            <div className="relative w-full max-w-xs mx-auto aspect-square">
                ...
                {[
                    ...
                    >
                        <span className="absolute -top-4 left-1/2 -translate-x-1/2 text-[8px] text-text-muted font-bold whitespace-nowrap">
                            {dot.label}
                        </span>
                    </motion.div>
                ))}
                        ...
                        <div className="p-8 sm:p-12">
                            ...
                            <div className="flex items-center justify-between mt-10 pt-6 border-t border-white/5">
                                <button
                                    onClick={prev}
                                    disabled={step === 0}
                                    className="flex items-center gap-2 text-sm text-text-muted hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                                >
