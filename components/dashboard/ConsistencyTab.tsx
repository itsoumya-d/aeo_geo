        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-4 flex flex-col gap-8">
                    ...
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="bg-white backdrop-blur-xl rounded-3xl border border-slate-200 p-10 text-center flex flex-col items-center justify-center shadow-xl relative overflow-hidden group h-full"
                    >
                        ...
                        <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 w-full">
                            <p className="text-slate-600 text-sm italic font-medium leading-relaxed line-clamp-4">
                                "{report.consistencyAnalysis}"
                            </p>
                        </div>

                        <div className="mt-8 pt-8 border-t border-slate-200 w-full flex items-center justify-between">
                            ...
                            <div className="flex flex-col items-end">
                                ...
                                <span className="text-xs font-black text-slate-900 uppercase tracking-widest">{report.brandConsistencyScore}/100</span>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <div className="bg-primary/10 backdrop-blur-xl rounded-3xl border border-primary/20 p-8">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest">AIE Insights</h4>
                        </div>
                        ...
                        <button className="flex items-center gap-2 text-[10px] font-black text-primary uppercase tracking-widest hover:text-slate-900 transition-colors group">
