...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
    ...
    return (
        <>
            <header className={`sticky top-0 z-30 w-full bg-surface/95 backdrop-blur-md border-b border-border transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-[68px]' : 'lg:pl-64'}`}>
                        ...
                        <div className="flex items-center gap-3 sm:gap-4 ml-auto">
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                <div
                                    ...
                                    className="hidden sm:flex items-center bg-background p-1 rounded-lg border border-border mr-1"
                                >
                                    <button
                                ...
                                <div className="hidden sm:flex items-center bg-background p-1 rounded-lg border border-border">
                                    <button
                                        onClick={onExportPDF}
