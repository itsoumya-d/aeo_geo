                ...
                {!report && activeTab === 'overview' ? (
                    ...
                    <>
                        <main
                            ...
                            className={`flex-1 p-4 pb-24 sm:p-6 sm:pb-24 lg:pb-6 lg:mt-0 transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-[68px]' : 'lg:ml-64'} ${isExporting ? 'bg-white !m-0 !p-0' : 'bg-background'}`}
                        >
                            {isExporting && report ? (
                                <PDFReportGenerator
                                    report={report}
                                ...
                                <div className="max-w-7xl mx-auto">
                                    ...
                                    {report && showActionHub && activeTab === 'overview' && (
                                        <div className="mb-6 bg-surface border border-border rounded-2xl p-5 shadow-card">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 items-stretch">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-left bg-background hover:bg-slate-50 border border-border hover:border-primary/40 rounded-xl p-5 transition-colors group h-full min-h-[156px] flex flex-col"
                                                    >
