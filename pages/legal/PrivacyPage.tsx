            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
                ...
                <Card variant="glass" className="border-border">
                    <div className="prose max-w-none">
                        ...
                        <h2 id="collect" className="text-text-primary font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">1. Information we collect</h2>
                        ...
                        <h2 id="use" className="text-text-primary font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">2. How we use information</h2>
                        <ul className="text-text-secondary leading-relaxed list-disc pl-5">
                        ...
                        <h2 id="retention" className="text-text-primary font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">3. Data retention</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="security" className="text-text-primary font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">4. Security</h2>
                        <p className="text-text-secondary leading-relaxed">
