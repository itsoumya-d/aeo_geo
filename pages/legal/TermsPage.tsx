            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
                <div className="flex items-center justify-between gap-4 mb-10">
                    <div className="min-w-0">
                        <h1 className="text-3xl sm:text-4xl font-display font-bold text-white">Terms of Service</h1>
                ...
                <Card variant="glass" className="border-white/10">
                    <div className="prose prose-invert max-w-none">
                        ...
                        <h2 id="eligibility" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">1. Eligibility</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="accounts" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">2. Accounts and Security</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="acceptable-use" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">3. Acceptable Use</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="billing" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">4. Billing</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="ip" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">5. Intellectual Property</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="disclaimers" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">6. Disclaimers</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="liability" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">7. Limitation of Liability</h2>
                        <p className="text-text-secondary leading-relaxed">
                        ...
                        <h2 id="termination" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">8. Termination</h2>
                        <p className="text-text-secondary leading-relaxed">
                            You may stop using the Service at any time. We may suspend or terminate access if we reasonably believe you have
                            violated these Terms.
                        </p>

                        <h2 id="contact" className="text-white font-display font-bold text-xl mt-10 mb-3 scroll-mt-6">9. Contact</h2>
                        <p className="text-text-secondary leading-relaxed">
