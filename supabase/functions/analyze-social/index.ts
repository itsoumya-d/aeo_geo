...
MAJOR PLATFORMS TO CHECK: Twitter/X, LinkedIn, YouTube, Instagram
...
Return JSON:
{
  ...
  "platformCoverage": number (0-100, % of 4 major platforms active),
  "platforms": [
    {
...
Include ALL 4 major platforms in the "platforms" array, setting "present": false for ones not provided.`;
